...
const OutlinePanel: FC<OutlinePanelProps> = ({ textBlocks, onScrollToBlock, collapsedTitles }) => {
      ...
      if (block.isTitle) {
          ...
          <div key={block.id} className="mb-2">
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="font-semibold text-sm text-amber-800 truncate">Título {block.titleNumber}</div>
            ...
            {!isCollapsed &&
              associatedParagraphs.map((paragraph) => (
                <div
                  key={paragraph.id}
        ...
        items.push(
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <div className="text-sm text-blue-700">Párrafo {block.number}</div>
              <div className="text-xs text-blue-500">{block.text.length} caracteres</div>
            </div>
          </div>,
        )
      }
