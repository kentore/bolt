...
const TextBlock: React.FC<TextBlockProps> = ({ block, onUpdateText, onDelete, onToggleCollapse, textBlocks }) => {
    ...
    >
      ...
      >
        <div className="flex items-center gap-2">
          {block.isTitle && (
            <Button variant="ghost" size="sm" onClick={handleToggleCollapse} className="p-1 h-auto hover:bg-white/50">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className={`font-medium ${block.isTitle ? "text-amber-800" : "text-blue-800"}`}>
